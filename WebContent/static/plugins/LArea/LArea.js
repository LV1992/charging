...
window.LArea = (function() {
    ...
    MobileArea.prototype = {
        ...
        bindEvent: function() {
            ...
            function popupArea(e) {
                ...
                _self.gearArea.innerHTML = '<div class="area_ctrl slideInUp">' +
                    ...
                    '</div>' +
                    '</div>' +
                    '</div><div class="Shield " style="position: fixed;top: 0;bottom: 0;left: 0;right: 0;z-index: 9900;"></div>';
        ...
        finish: function(e) {
            ...
            //mm 添加内容
            $(_self.trigger).find('em').html((cityText)?(cityText):(''));
            mapObj.centerAndZoom((cityText)?(cityText):(''),12);
